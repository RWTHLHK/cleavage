 ...
 */
class ComputeOrientationCrackedStress : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  ComputeOrientationCrackedStress(const InputParameters & parameters);
...
protected:
  ...
  /// projection on 3 cleavage planes
  MaterialProperty<Real> & _p1_square;
  MaterialProperty<Real> & _p2_square;
  MaterialProperty<Real> & _p3_square;
  MaterialProperty<Real> & _k0;
  /// rotation matrix
  const MaterialProperty<RankTwoTensor> & _cry_rot;
};
