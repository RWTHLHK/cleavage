 ...
 */
class ComputeCleavageCrackedStress : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  ComputeCleavageCrackedStress(const InputParameters & parameters);
...
protected:
  ...
  /// critical damage that macroscopic fracture occurs
  const Real _d_crit;
